...
namespace MathForGames
{
    class UIText : Actor
    {
        ...
        /// <summary>
        /// The width of the text box. If the cursor is outside of the max
        ...
        /// y position the text ix truncated.
        /// </summary>
        public int Height
        {
            get { return _height; }
        ...
        /// <summary>
        /// Sets the starting values for the text bos
        /// </summary>
        ...
        /// <param name="width">How wide the text box</param>
        /// <param name="height">How tall the text box</param>
        ...
        public override void Draw()
        {
            ...
            for (int i = 0; i < textChars.Length; i++)
            {
                ...
                {
                    //Reset the curso x position and increase the y position
                    cursorPosX = (int)Position.X;
                    cursorPosY++;
                }
                //If the cursor has reached the maximum height...
                if ((int)Position.Y + Height < cursorPosY)
                    //...leave the loop
                    break;
            }
